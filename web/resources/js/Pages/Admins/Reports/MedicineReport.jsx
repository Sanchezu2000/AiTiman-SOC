...
const MedicineReport = ({ medicines }) => {
    ...
    const handleSearch = (e) => {
        ...
        const filtered = medicines.filter(({ medicine_name, description }) =>
            ...
            <AdminLayout>
                ...
                <div className="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="font-medium text-lg">Manage Medicines Reports</h2>
                    </div>
